...
new.cluster.ids <- as.matrix(read.csv("./markers_a.csv"))
names(new.cluster.ids) <- levels(app_integrated)
app_integrated <- RenameIdents(app_integrated, new.cluster.ids)
levels(app_integrated) <- c("Microglia", "Oligodendrocytes", "Endothelial cells", "ARPs","Astrocytes", "Neural stem cells", "Neuroblasts", "mNEUR", "Pericytes", "Macrophages", "NEUTs", "CPCs","OEGs", "Blood cells", "VSMCs", "VLMCs", "Tancytes", "Monocytes", "Unknown glial cells 1", "Unknown glial cells 2", "Unknown cells 1", "Unknown cells 2", "Unknown cells 3")
